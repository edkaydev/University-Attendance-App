...
A comprehensive web-based attendance tracking system built with React, TypeScript, and Tailwind CSS for Martyrs University. The system supports role-based access for students, lecturers, and administrators with QR code-based attendance marking.
...
1. **Clone the repository**
   ```bash
   git clone <https://github.com/edkaydev/University-Attendance-App>
